...
- You will need to write a bit of logic (or use [ours](rps_model.rb)) that compares the two hands and decides which one has won, and then use that in the route definition.
